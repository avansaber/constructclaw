"""Shared pytest fixtures for ConstructClaw unit tests."""
import os
import sys
...
import pytest
from construct_helpers import init_all_tables, get_conn, build_env, load_db_query


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with full ERPClaw core + constructclaw schema."""
...
@pytest.fixture
def env(conn):
    """Full constructclaw environment: company, customer, naming series."""
